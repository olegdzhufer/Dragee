...
// void VirtLiquidCrystal::init(uint8_t lcd_cols, uint8_t lcd_rows, uint8_t charsize)
// {
//   _cols = lcd_cols;
//   _rows = lcd_rows;
...
void VirtLiquidCrystal::init(uint8_t mode) 
{
...
// void VirtLiquidCrystal::clear(uint8_t rowStart, uint8_t colStart, uint8_t colCnt) {
...
void VirtLiquidCrystal::setCursor(uint8_t col, uint8_t row, uint8_t offsets[])
{
  if (row > _rows)
  {
...
void VirtLiquidCrystal::printstr(const char c[])
{
